...
/**
 * A NewMinedTree is created from an array of student data using the ID3 algorithm.
 ...
 * @date 9 Feb 2010
 */
public class NewMinedTree extends Tree {
    int correct;
    String[] key;
    ...
    /**
     * Make a new NewMinedTree from the given inputs.
     ...
     */
    public NewMinedTree(double threshold, int correct, String[] key,
            ...
            Collection<String[]> students, int question)
    {
        ...
        if (bestQuestion != -1) {
            ...
            right = new NewMinedTree(threshold, correct, key,
                    findAnswers(bestQuestion, true), bestQuestion);
            //System.out.println("Make wrong");
            wrong = new NewMinedTree(threshold, correct, key,
    ...
    public Collection<String[]> findPassing(boolean passing, Collection<String[]> students)
    {
    ...
    public static void main(String args[]) throws IOException 
    {
        ...
        System.out.println(new NewMinedTree(.2, 10, key, answers));
    }
}
